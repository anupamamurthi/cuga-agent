"""
Dummy product catalog tools — identical to cuga_with_plugins/catalog_tools.py.

These are plain LangChain tools with no dependency on CUGA or LangGraph internals.
In the CUGA version they were registered via CatalogPlugin.on_tools_build().
In this LangGraph version they are imported and passed directly to create_react_agent().
"""
