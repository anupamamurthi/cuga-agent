"""
Multi-provider LLM factory — shared by all langgraph_react examples.

Identical to docs/examples/demo_apps/_llm.py — copied here to avoid
cross-directory imports and keep each example self-contained.
...
Supported providers and required env vars:
    ...
    rits      RITS_API_KEY  (RITS_BASE_URL optional)
...
def create_llm(
    ...
    Returns:
        Instantiated BaseChatModel ready to pass to create_react_agent(model=...).
    """
